...
const SquareCard = ({ title, subtitle, content1, content2}) => {
  return (
    <div className="container flex flex-1 flex-col items-center justify-center mx-auto shadow-lg border-2 rounded-lg m-12 w-11/12 lg:w-2/6 md:11/12 py-10 px-4 lg:px-10 md:px-10">
