...
const ArtsCard = ({ title, timeframe, description, day }) => {
  return (
    <div className="container flex flex-1 flex-col items-center justify-center mx-auto shadow-lg border-2 rounded-lg mt-20 sm:mt-24 mb-12 w-11/12 md:w-5/6 lg:w-5/6 p-10">
      <h1 className="mx-10 text-xl lg:text-3xl md:text-3xl uppercase text-seaFoam-700">{title}</h1>
      <p className="text-lg lg:text-2xl md:text-2xl uppercase text-seaFoam-400 font-semibold my-4">
        {day} Rehearsals
      </p>
      <div className="h-0.5 w-full rounded-lg bg-gray-200 mx-10 my-5"></div>
      <div>
