...
const NewSubscriptionSection = () => {
  const userContext = useContext(UserContext);
    ...
    const checkoutSuccess = () => {
      ...
      setSuccess(true);
      userContext.setNewSubscription(selectedPlan.unit_amount / 100);
    }
  ...
  return (
    <>
      ...
      >
        <PlanCheckoutForm checkoutSuccess={checkoutSuccess} selectedPlan={selectedPlan} />
      </Modal>
      <UIModal
      centerModal={true}
      opened={success}
      onClose={() => setSuccess(false)}
        type="success"
        message={`Success! You're now subscribed to regular donations. You will be charged $${selectedPlan?.unit_amount / 100} today, and each month going forward until you cancel. Thank you for contributing to Asbury's mission! You can manage your new subscription in your user profile.`}
      />
      <div className="flex flex-1 flex-col justify-center items-center border-2 shadow-md rounded-lg p-4 w-11/12 lg:w-2/6 md:w-2/6 mx-auto">
        ...
        <ul className="text-center font-semibold">
          ...
          <li className="mb-4 text-gray-500">Monthly</li>
