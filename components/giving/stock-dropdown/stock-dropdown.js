...
const StockDropdown = ({ title, content }) => {
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex justify-center items-center">
                <Link href="/giving/security-donations" passHref>
              <button className="py-3 px-7 bg-emerald-900 hover:bg-seaFoam-600 text-white uppercase font-semibold rounded-lg mt-4 w-full">
                Learn More
              </button>
                </Link>
            </div>
